...
Route::middleware('auth')->group(function(){
    ...
    //ADDED THIS
    Route::get('/admin/users/{id}/update',[AdminController::class,'updateUser'])->name('updateUser')->middleware('role:admin');
    Route::post('/admin/users/{id}/update',[AdminController::class,'update'])->name('update')->middleware('role:admin');
    
    Route::delete('/admin/users/{id}', [AdminController::class, 'delete'])->name('delete')->middleware('role:admin');
